      ...
      timeline: [
        ...
        },
        {
          ...
          projects: [
            ...
            {
              title: "IBM DeepSense Ocean Data Analytics Partnership",
              description:
            ...
            {
              title: "IBM/UNB Collaboration on Covid-19 Mitigation Strategies",
              description:
            ...
            {
              title: "Major US Banking Institution",
              description:
            ...
            {
              title: "Home Improvement Department Store",
              description:
            ...
            {
              title: "At Home Medical Care Booking System",
              description:
            ...
            {
              title: "Government Passport Renewal Application",
              description:
            ...
            {
              title: "Major US Banking Provider - Term 2",
              description:
            ...
            {
              title: "New Client - Tech Lead/Scrum Master",
              description:
            ...
            {
              title: "Major US Banking Provider - Term 3",
              description:
