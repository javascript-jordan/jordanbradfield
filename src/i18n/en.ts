    ...
    EXPERIENCES: {
      timeline: [
        ...
        },
        {
          ...
          projects: {
            "Canadian Railway Travel Booking Application": {
              description:
            ...
            "IBM DeepSense Ocean Data Analytics Partnership": {
              description:
            ...
            "IBM/UNB Collaboration on Covid-19 Mitigation Strategies": {
              description:
            ...
            "Home Improvement Department Store": {
              description:
            ...
            "At Home Medical Care Booking System": {
              description:
            ...
            "Government Passport Renewal Application": {
              description:
            ...
            "Major US Banking Institution - Term 2": {
              description:
            ...
            "Major US Banking Provider - Term 3": {
              description:
